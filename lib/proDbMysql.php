 ...
 * @package   proDbMysql
 * @author    Kerul Patel <contact@adaptable.pro>
...
class proDbMysql
{
     ...
     *
     * @uses $db = proDbMysql::getInstance();
     *
     * @return proDbMysql Returns the current instance.
     */
     ...
     *
     * @uses $proDbMysql->setQueryOption('name');
     *
     ...
     *
     * @uses $proDbMysql->where('id', 7)->where('title', 'MyTitle');
     *
     ...
     *
     * @uses $proDbMysql->orWhere('id', 7)->orWhere('title', 'MyTitle');
     *
     * @param string $whereProp  The name of the database field.
     * @param mixed  $whereValue The value of the database field.
     * @param string $operator Comparison operator. Default is =
     ...
     *
     * @uses $proDbMysql->having('SUM(tags) > 10')
     *
     ...
     *
     * @uses $proDbMysql->orHaving('SUM(tags) > 10')
     *
     * @param string $havingProp  The name of the database field.
     * @param mixed  $havingValue The value of the database field.
     * @param string $operator Comparison operator. Default is =
     ...
     *
     * @uses $proDbMysql->join('table1', 'field1 <> field2', 'LEFT')
     *
     ...
     *
     * @uses $proDbMysql->orderBy('id', 'desc')->orderBy('name', 'desc');
     *
     ...
     *                       
     * @throws Exception
     * @return proDbMysql if succeeeded;
     */
    ...
    public function _buildDataPairs($tableData, $tableColumns, $isInsert)
    {
        foreach ($tableColumns as $column) {
            ...
            // Subquery value
            if ($value instanceof proDbMysql) {
    ...
    /**
     * Method creates new proDbMysql object for a subquery generation
     * 
    ...
    /**
     * Method returns a copy of a proDbMysql subquery object
     *
     * @return proDbMysql new proDbMysql object
     */
    ...
    /**
     * Get where and what function was called for query stored in proDbMysql->trace
     *
