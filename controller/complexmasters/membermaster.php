	...
	?>
		<div class="row">
			...
			<div class="col-sm-10 py-1 mt-1 mb-3">
				<a href="<?php echo $formaction; ?>" class="btn btn-info float-right ml-2"><i class="fe-plus"></i> Add New Member</a>
			</div>
		</div>
		<div class="row">
			<div class="col-sm-12">
				<div class="card">
					<div class="card-body">
						<div class="table-responsive">
							<table cellpadding="1" cellspacing="2" border="0" class="table table-striped table-bordered dataTable" id="memberList" width="100%">
								<thead>
									<tr>
										<th>Office</th>
										<th>Residence</th>
										<th>Image</th>
										<th width="20%">Resident (Admin Role)</th>
										<th>Contact</th>
										<th>Profession</th>
