(function ($) {
  ...
  $(function () {
    ...
    if ($("#visit-sale-chart").length) {
      ...
      var gradientStrokeGreen = ctx.createLinearGradient(0, 0, 0, 360);
      gradientStrokeGreen.addColorStop(0, 'rgba(6, 185, 157, 1)');
      gradientStrokeGreen.addColorStop(1, 'rgba(132, 217, 210, 1)');
      var gradientLegendGreen = 'background:linear-gradient(to right, rgba(6, 185, 157, 1), rgba(132, 217, 210, 1))';
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ['04 AM', '07 AM', '08 AM', '09 AM', '10 AM', '11 AM'],
          datasets: [
            {
              label: "Daily Staff",
              borderColor: gradientStrokeViolet,
    ...
    if ($("#traffic-chart").length) {
      ...
      var trafficChartData = {
        ...
        labels: [
          'Paid Invoices  (9.78%)',
          'Pending Invoices  (1.09%)',
          'Failed Invoices  (0.00%)',
          'Due Invoices  (1.09%)',
        ]
      };
